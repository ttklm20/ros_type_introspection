...
int main(int argc, char** argv)
{
    ...
    for(const rosbag::ConnectionInfo* connection: bag_view.getConnections() )
    {
        ...
        std::cerr << "\033[1;31m++      Print out a message informations        ++\033[0m " << std::endl;
        std::cerr << "\033[1;32m++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m" << std::endl;
       
        std::cerr << "\n\n\033[1;32m Topic name:\033[0m\n" << topic_name << "\n\n"<< std::endl;

        std::cerr << "\033[1;32m Datatype:\033[0m\n" << datatype << "\n\n"<< std::endl;
        std::cerr << "\033[1;32m Msg Defination:\033[0m\n" << definition << "\n\n"<< std::endl;
